...
{
	{
		...
		float L_23 = ___t2;
		L_16->set_z_2(((float)il2cpp_codegen_add((float)L_18, (float)((float)il2cpp_codegen_multiply((float)((float)il2cpp_codegen_subtract((float)L_20, (float)L_22)), (float)L_23)))));
		...
		float L_31 = ___t2;
		L_24->set_w_3(((float)il2cpp_codegen_add((float)L_26, (float)((float)il2cpp_codegen_multiply((float)((float)il2cpp_codegen_subtract((float)L_28, (float)L_30)), (float)L_31)))));
		// }
		return;
	}
}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR bool U3CU3Ec_U3COnEnableU3Eb__3_0_mFB0450A2EA91C54C174F251C8F4B5B520F5314CE (U3CU3Ec_t582D59DA00DB9923A86F7788D2FDFB1DBECDC721 * __this, FieldInfo_t * ___t0, const RuntimeMethod* method)
{
	...
	}
	{
		...
		NullCheck(L_1);
		bool L_4;
		L_4 = VirtFuncInvoker1< bool, Type_t * >::Invoke(116 /* System.Boolean System.Type::IsSubclassOf(System.Type) */, L_1, L_3);
		return L_4;
	}
}
